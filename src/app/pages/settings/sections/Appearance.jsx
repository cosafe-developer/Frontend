...
export default function Appearance() {
  ...
  useDidUpdate(() => {
    for (let i = 0; i < 3; i++) toast("Esto es una Notificación");
  ...
  return (
    <div className="w-full max-w-3xl 2xl:max-w-5xl">
      ...
      <p className="mt-0.5 text-balance text-sm text-gray-500 dark:text-dark-200">
        Personaliza la apriencia de la aplicación según tus preferencias.
      </p>
      ...
      <div className="space-y-8">
        ...
        <div>
          <div>
            ...
            <p className="mt-0.5">
              Selecciona el color primario que quieres utilizar.
            </p>
          </div>
          <RadioGroup
        ...
        <div>
          <div>
            ...
            <p className="mt-0.5">
              Selecciona el esquema de color para el tema Light que más te guste.
            </p>
          </div>
          <RadioGroup
        ...
        <div>
          <div>
            ...
            <p className="mt-0.5">
              Selecciona el esquema de color para el tema Dark que más te guste.
            </p>
          </div>
          <RadioGroup
      ...
      <div>
        <div>
          ...
          <p className="mt-0.5">
            Selecciona el estilo de las notificaciones.
          </p>
        </div>
        <div className="mt-3">
          ...
          >
            <Label className="sr-only">Estilo de grupo para las Notificaciones</Label>
        ...
        <div className="mt-4">
          ...
          <RadioGroup
            ...
            className="mt-3 text-center"
          >
            <Label className="sr-only">Cantidad máxima de Notificaciones</Label>
        ...
        <div className="mt-5 grid grid-cols-1 md:grid-cols-3">
          <p className="my-auto">Posición de la Notificación:</p>
          <Listbox
            classNames={{
      ...
      <div className="space-y-5">
        <div className="grid grid-cols-1 md:grid-cols-3">
          <p className="my-auto">Skin de Cards:</p>
          <Listbox
            classNames={{
              root: "mt-1.5 flex-1 md:col-span-2 md:mt-0",
            }}
