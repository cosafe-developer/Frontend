...
const EstudioStep6 = ({ onNext, onPrev, listado }) => {
  ...
  useEffect(() => {
    if (listado && physicochemicalAgentCtx) {
      const newData = resetDataEstudioStep6({ listado, physicochemicalAgentCtx });
