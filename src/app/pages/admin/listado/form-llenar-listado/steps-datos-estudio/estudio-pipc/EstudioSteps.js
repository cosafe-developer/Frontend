...
export const estudioSteps = [
  ...
  { key: "structuralRisks", component: EstudioStep2, label: "Riesgos por daños estructurales" },
  { key: "serviceInstallations", component: EstudioStep3, label: "Riesgos por deficiencia en las instalaciones de servicio del inmueble" },
  { key: "socioOrganizationalAgent", component: EstudioStep4, label: "Agente Perturbador Socio-Organizativo" },
  { key: "geologicalAgent", component: EstudioStep5, label: "Agente Perturbador Geológico" },
  { key: "physicochemicalAgent", component: EstudioStep6, label: "Agente Perturbador Físico-Químico" },
  { key: "sanitaryAgent", component: EstudioStep7, label: "Agente Perturbador Sanitario" },
  { key: "surroundingRisks", component: EstudioStep8, label: "Riesgos Circundantes" },
