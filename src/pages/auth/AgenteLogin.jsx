...
import { ApiLoginAgente, checkAgenteSession } from '../../api/agente/login';
...
const AgenteLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const data = await ApiLoginAgente(email, password);
  ...
  return (
    <main className="min-h-screen bg-[#0E0F11] flex flex-col items-center justify-center px-4 space-y-6">
      <div className="text-center">
        ...
        <h2 className="text-white text-2xl font-semibold">Bienvenido agente</h2>
