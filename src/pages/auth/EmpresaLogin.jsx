...
import { ApiLoginEmpresa, checkEmpresaSession } from '../../api/empresa/login';
...
const EmpresaLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const data = await ApiLoginEmpresa(email, password);
      console.log('Login empresa exitoso:', data);
      navigate('/empresa');
    } catch (err) {
